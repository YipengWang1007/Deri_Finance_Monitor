...
class Monitor:
    def __init__(self, web3: Web3, contract: Contract, state: MonitorState, events: List, filters: {},
                 max_chunk_scan_size: int = 4999, max_request_retries: int = 30, request_retry_seconds: float = 3.0):
        """
...
if __name__ == "__main__":
    ...
    def run():
      ...
      },
      {
        ...
        start_block = max(state.get_last_scanned_block() - chain_reorg_safety_blocks, 7984650)
